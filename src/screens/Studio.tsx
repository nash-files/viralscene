      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between bg-surface-container-low p-4 rounded-2xl border border-outline-variant/10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-label uppercase tracking-widest text-on-surface/40">Your Balance</p>
              <p className="font-headline font-bold text-lg">{user?.coins ?? "..."} Coins</p>
            </div>
          </div>
          <div className="flex gap-2">
            {canClaim && (
              <button 
                ...
                disabled={isClaiming}
                className="px-4 py-2 bg-secondary text-on-secondary rounded-full text-xs font-bold font-label uppercase tracking-tight flex items-center gap-2"
              >
                <Gift className="w-4 h-4" />
                {isClaiming ? "Claiming..." : "Daily Reward"}
              </button>
            )}
            <button className="px-4 py-2 bg-primary text-on-primary rounded-full text-xs font-bold font-label uppercase tracking-tight">
              Get More
            </button>
          </div>
        </div>
